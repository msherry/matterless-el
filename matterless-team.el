;;; matterless-team.el --- MatterMost teams -*- lexical-binding: t; -*-
...
(defvar matterless-teams
  "List of MM teams we sign into"
  nil)
(defvar matterless-current-team
  "The MM team we currently care about"
  nil)

(defclass matterless-team ()
  ())

(defun matterless-create-team (plist)
  "Create MM team object from PLIST.
PLIST are the slots of our team."
  (let ((team (apply #'make-instance 'matterless-team
                     (matterless-collect-slots 'matterless-team plist))))
    team))

(provide 'matterless-team)
;;; matterless-team.el ends here
